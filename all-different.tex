...
\begin{frame}{Some Experiments}
    ...
    \only<13> {
        \scalebox{0.7}{\lstinputlisting[basicstyle=\fontsize{5pt}{6pt}\ttfamily]{code/huge.txt}}
    }
...
\begin{frame}{Do Global Constraints Always Help?}
    \begin{itemize}
        ...
        \item Some global constraints can only be decomposed down to binary constraints in a very
            unpleasant way involving lot of extra variables.
