...
\begin{frame}[fragile]{A Sudoku Solver in Choco}
    \only<1>{\lstinputlisting[basicstyle=\scriptsize\ttfamily]{herald20061222E.txt}}
    \only<2>{\lstinputlisting[language=Java, basicstyle=\scriptsize\ttfamily, keywordstyle=\color{uofgcobalt}]{Sudoku-1-snippet.java}}
    \only<3>{\lstinputlisting[language=Java, basicstyle=\scriptsize\ttfamily, keywordstyle=\color{uofgcobalt}]{Sudoku-2-snippet.java}}
    \only<4>{\lstinputlisting[language=Java, basicstyle=\scriptsize\ttfamily, keywordstyle=\color{uofgcobalt}]{Sudoku-3-snippet.java}}
    \only<5>{\lstinputlisting[language=Java, basicstyle=\scriptsize\ttfamily, keywordstyle=\color{uofgcobalt}]{Sudoku-4-snippet.java}}
    \only<6-7>{
        \lstinputlisting[language=Java, basicstyle=\scriptsize\ttfamily, keywordstyle=\color{uofgcobalt}]{Sudoku-5-snippet.java}
        \begin{tikzpicture}[remember picture, overlay]
    ...
    \only<8>{\lstinputlisting[language=Java, basicstyle=\scriptsize\ttfamily, keywordstyle=\color{uofgcobalt}]{Sudoku-6-snippet.java}}
    \only<9>{\lstinputlisting[language=Java, basicstyle=\scriptsize\ttfamily, keywordstyle=\color{uofgcobalt}]{Sudoku-7-snippet.java}}
\end{frame}
